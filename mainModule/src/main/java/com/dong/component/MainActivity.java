...
public class MainActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        Fragment fragmentHome = ReflectUtils.getFragment("com.dong.goodsmodule.HomeFragment");
        Fragment fragmentSort = ReflectUtils.getFragment("com.dong.goodsmodule.SortFragment");
        Fragment fragmentCart = ReflectUtils.getFragment("com.dong.cartmodule.CartFragment");
        Fragment fragmentMine = ReflectUtils.getFragment("com.dong.usermodule.MineFragment");
